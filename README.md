...
| Planespotters   | N                              | planespotters.net                                         | adsb:`feed.planespotters.net` port `30004`<br/>mlat: `mlat.planespotters.net` port `31090` | `adsb,feed.aplanespotters.net,30004,beast_reduce_plus_out;`<br/>`mlat,mlatplanespotters.net,31090` |
