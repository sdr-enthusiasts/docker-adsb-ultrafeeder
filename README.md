...
| ADSBItalia      | N                             | New adsb network from Italy. See <https://www.adsbitalia.it>. See below on how to configure a feed to them | adsb: `feed.adsbitalia.it` port 31108<br/>mlat: `mlat.adsbitalia.it` port `41113`               | `adsb,feed.adsbitalia.it,31108,beast_reduce_plus_out;`<br/>`mlat,malt.adsbitalia.it,41113`                 |
