...
| Skydex | N | Browser flight game on live ADS-B: feeding turns an antenna into a public station page with stats. See <https://feed.skydex.online/> | adsb: `feed.skydex.online` port `30004`<br/>mlat: no MLAT | `adsb,feed.skydex.online,30004,beast_reduce_plus_out;` |
